...
<body class="bg">
  ...
  <div class="container-fluid p-3 ">
    <nav class="navbar nav1 navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Blog_page.php"><h4>Blogs</h4></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="contact_us.php"><h4>contact Us</h4></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="requestpage.php"><h4>Request</h4></a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="login_re_prince/user_registration.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><h5>Sign Up</h5></a>

          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="login_re_prince/user_registration.php">User Sign Up</U></a>
            <a class="dropdown-item" href="login_re_prince/admin_login.php">Admin-Login</a>
          </div>
        </li>
        ...
        <div>
          <a href="cart.php"><i class='fas fa-cart-arrow-down' style='font-size:36px;color:black; margin-right:20px;cursor:pointer'></i></a>
        </div>
    ...
    <a href='index.php?category=$category_id' class='nav-link text-light'>$category_title</a></li>";
          ...
          ?>
      <button href="" type="button" class="btn btn-dark"> <a href="insert_product.php" class="link-danger">sell</a></button>
        </ul>
        <h5 class="ml-2 "><?Php  
